...
class Hello_world extends egret.DisplayObjectContainer {
    ...
    private init_hammer_animation() {
        ...
        var texture = RES.getRes("hammer_png");//获取动画文件的图片
    ...
    private timerComFunc() {
        ...
        //修改title
        document.title = "小锤锤被我的大锤锤捶了" + this.hammer_account + "锤，" +
            "快来用你的大锤锤捶小锤锤，记住秘诀：大力！快速！！";
